...
$sql = "SELECT * FROM peminjaman INNER JOIN buku ON peminjaman.id_buku = buku.id_buku INNER JOIN detail_pinjam ON peminjaman.id_pinjam = detail_pinjam.id_pinjam";
